...
export default function StepDeadline() {
  ...
  const val = useWatch({ control: form.control, name: "wish_deadline" }) ?? "";
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="ml-0">
                  <FormLabel className="text-base leading-6">
                    When do you realistically want to complete this by
                  </FormLabel>
                  <FormDescription className="leading-5">
                    Set a timeline that is realistic but motivating
                  </FormDescription>
                </div>
              </div>
              ...
              <div className="mt-3">
                <div className="relative">
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Example: Aim to complete by September 30 or within 6 months with milestones at 30 and 90 days"
                      maxLength={MAX}
                      className="min-h-32 resize-y border border-gray-300 pr-24 bg-white"
                      aria-describedby="deadline-counter"
                    />
                  </FormControl>
