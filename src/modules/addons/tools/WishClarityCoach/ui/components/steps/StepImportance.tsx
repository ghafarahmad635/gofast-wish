...
export default function StepImportance() {
  ...
  const val = useWatch({ control: form.control, name: "wish_importance" }) ?? "";
    ...
    <Form {...form}>
      <Card className="p-4 md:p-6">
        <FormField
          ...
          name="wish_importance"
          render={({ field }) => (
            <FormItem>
              {/* Row 1: icon left, text right with no gap */}
              <div className="flex items-center gap-5">
                ...
                <div className="ml-0">
                  <FormLabel className="text-base leading-6">
                    What makes this wish truly important to you
                  </FormLabel>
                  <FormDescription className="leading-5">
                    What makes this meaningful right now
                  </FormDescription>
                </div>
              </div>
              ...
              <div className="mt-3">
                <div className="relative">
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Think about why this goal matters on a personal level"
                      maxLength={MAX}
                      className="min-h-32 resize-y border border-gray-300 pr-24 bg-white"
                      aria-describedby="importance-counter"
                    />
                  </FormControl>

                  {/* Live counter */}
                  <span
                    id="importance-counter"
