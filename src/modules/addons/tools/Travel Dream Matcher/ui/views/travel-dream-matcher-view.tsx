...
import TravelGenerateForm from '../components/travel-dream-matcher-generate-form'
import TravelPlanCard from '../components/travel-dream-matcher-idea-card'
import type { TravelPlans } from '../../schema' 
  ...
  return (
    <>
      ...
      <div className="py-5 px-4">
        ...
        <TravelGenerateForm onGenerate={setPlans} toolID={id} onLoadingChange={setIsGenerating} />
        ...
        {plans.length > 0 && (
          <div className="mt-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              {isGenerating && (
                <span className="text-sm px-2 py-1 rounded bg-gray-100 border">Generating…</span>
              )}
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {plans.map((plan, i) => (          // ✅ each plan is a TravelPlan
                <TravelPlanCard
                  key={`${plan.title}-${i}`}
                  index={i}
                  plan={plan}
...
export const TravelDreamMatcherViewLoadingState = () => (
...
export const TravelDreamMatcherViewErrorState = () => (
  <ErrorState
